...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (text.includes("MEETING: team")) {
      ...
      const teamPrompts: any = {

        rahaf: `
أنت رهف خبيرة العقارات في مكة.

قدم تقريراً عن:
- سوق الإيجارات في مكة
- مقارنة الأحياء مثل الربوة والشوقية
- فرصة استثمار عقاري

ثم أعط توصية عقارية واضحة.
`,

        noura: `
أنت نورة خبيرة تيك توك والتسويق.
...
ثم أعط توصية لزيادة المشاهدات.
`,

        mohammed: `
أنت محمد خبير الفرص التجارية في السوق السعودي.

قدم تقريراً عن:
- فرصة مشروع مربح
- اتجاه السوق
- فكرة تجارة قابلة للتنفيذ

ثم أعط توصية عملية.
`,

        saad: `
أنت سعد محلل الاستثمار والأسواق.

قدم تقريراً عن:
- وضع الأسواق
- اتجاه الذهب أو الأسهم
- فرصة استثمارية

ثم أعط توصية استثمارية.
`
      };
      ...
      for (const m of teamMembers) {
        ...
        const memberResponse = await client.messages.create({
          model: "claude-opus-4-5",
          max_tokens: 400,
          system: teamPrompts[m],
          messages: [{ role: "user", content: "اعطني تقريرك الآن." }],
        });
